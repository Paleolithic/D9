	...
	<div id="mask">
		...
		<div id="item1" style="background-color: rgba(39,35,48,.2);" class="item">
			<div class="top">
				...
				<p id="title2">The &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  of District 9</p>
				<div><p><a href='#'>Profit</a></p></div>
			</div>	
		...
		<div id="item2" style="background-color: rgba(153,173,151,.2);" class="item">
			<div class="top">
				<div><p><a href='#'>Reviews</a></p></div>
			</div>
			<div class="content">			
				...
				<a href='http://en.wikipedia.org/wiki/District_9#Reviews' style='top: 0px; text-align: right; display: block; padding-right: 10px; color:#DFE0AF;'>Paraphrased from - Wikipedia</a></p>
				<div style="margin-bottom: 20px;">
					<div class="progressBar" id="rt"><div></div></div>
		...
		<div id="item3" style="background-color: rgba(86,148,146, .2);" class="item">
			<div class="top">
				<div><p><a href='#'>Controversy</a></p></div>
				<img src='assets/images/pictures_test.png' style="position: relative; top: 6px; left: 600px;" alt='Pictures' />
			</div>
			<div class="content" >
