	...
	<div id="mask">
		<div id="item1" style="background-color: rgba(39,35,48,.2);" class="item">
			<div class="top">
				...
				<div><p><a href='#'>Development</a></p></div>
				<img src='assets/images/alien_outline.png' style="position: relative; top: 20px; left: 180px;" alt='Alien'/>
			</div>	
		...
		<div id="item2" style="background-color: rgba(153,173,151,.2);" class="item">
			<div class="top">
				<div><p><a href='#'>Filming</a></p></div>
				<img  src="assets/images/no_aliens.png"  style="position: relative; top: 20px; left: 200px;" alt="support" />
			</div>
			<div class="content">			
		...
		<div id="item3" style="background-color: rgba(86,148,146, .2);" class="item">
			<div class="top">
				<div><p><a href='#'>Visual Effects</a></p></div>
				<img src='assets/images/alien.png' style="position: relative; top: 20px; left: 180px;" alt='Alien'/>
			</div>
			<div class="content" >
