...
<body>
	...
	<div id="mask">
		<section data-speed="10" data-type="background" class='item' style='margin-top: 65px;' id="one">
			<div class='container'>
				<div class='seven columns offset-by-two title' style='padding-top: 35px;'><h2><a href='#one'>Development</a></h2></div>
		...
		<section data-speed="4" data-type="background" class='item' id="two">	
			<div class='container'>
				<div class='seven columns offset-by-two title'><h2><a href='#two'>Filming</a></h2></div>
				<div class="fourteen columns offset-by-one">			
		...
		<section data-speed="6" data-type="background" class='item' id="three" >
			<div class='container'>
				<div class='seven columns offset-by-two title'><h2><a href='#three'>Visual Effects</a></h2></div>
